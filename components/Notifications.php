<?php namespace JosephCrowell\Passage\Components;
...
class Notifications extends ComponentBase
{
    ...
    public function defineProperties()
    {
        return [
            ...
            "includeAssets" => [
                ...
                "comment" =>
                    "Inject the JavaScript and Stylesheet used by the default component markup",
                "type" => "checkbox",
                "default" => true,
            ],
        ];
    ...
    {
        return ((int) post("records_per_page")) ?:
            $this->property("recordsPerPage");
    }
